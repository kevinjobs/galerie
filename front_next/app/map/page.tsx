...
export default function Map() {
        ...
        AMapLoader.load({
          ...
          .then((AMap: any) => {
            ...
            const map = new AMap.Map("map-container", {
              ...
              zoom: 5, //地图级别
              center: [118, 31], //地图中心点
              mapStyle: "amap://styles/grey", //设置地图的显示样式，取值请参考 https://lbs.amap.com/api/javascript-api/reference/map-style#mapstyle
            });
            ...
            if (data?.lists?.length) addLayer(data?.lists);
          })
          .catch((e: any) => {
  ...
  return <>
    {
      isMobile ? <div id="map-container" className="w-full h-[calc(100vh-56px)]"></div>
        : <div id="map-container" className="w-full h-[calc(100vh-64px)]"></div>
    }</>;
}
